    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ->add('isProductionMode', ChoiceType::class, [
                ...
                'label' => 'czende.gopay_plugin.is_production_mode',
            ])
            ...
            ->add('clientId', TextType::class, [
                'label' => 'czende.gopay_plugin.client_id',
                'constraints' => [
                    new NotBlank([
                        'message' => 'czende.gopay_plugin.gateway_configuration.client_id.not_blank',
                        'groups' => ['sylius'],
                    ])
                ],
            ])
            ->add('clientSecret', TextType::class, [
                'label' => 'czende.gopay_plugin.client_secret',
                'constraints' => [
                    new NotBlank([
                        'message' => 'czende.gopay_plugin.gateway_configuration.client_secret.not_blank',
                        'groups' => ['sylius'],
                    ])
                ],
            ]);
